      ...
      <div className='w-full max-w-md space-y-8'>
        ...
        <div className='flex justify-center'>
          <div className='relative'>
            ...
            <div className='bg-card border-border relative rounded-full border-2 p-6'>
              <ShieldX className='text-muted-foreground h-16 w-16' strokeWidth={1.5} />
            </div>
          </div>
        </div>
        ...
        <div className='space-y-4 text-center'>
          <div className='space-y-2'>
            <h1 className='text-5xl font-bold tracking-tight text-balance'>401</h1>
          ...
          <p className='text-muted-foreground mx-auto max-w-sm leading-relaxed text-balance'>
            You need to sign in to access this resource. Please log in with your credentials to
            continue.
          </p>
        </div>
